...
<head>
    ...
    <title>BloodLink - Need Blood Registration</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="tagline">Urgent Help, Life-Saving Donations</div>

        <div class="registration-form">
            <h3>Register to Request Blood</h3>
            <form id="needBloodForm" method="POST" action="/home/needblood">
                @csrf
                ...
                <button type="submit">Request Blood Now</button>
